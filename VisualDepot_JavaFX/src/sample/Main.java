...
public class Main extends Application {
    ...
    private Scene entryScene(Stage primaryStage){
        ...
        //setOnAction:
        but1.setOnAction(e->{
            primaryStage.setScene(new LoginScene().display(primaryStage,scene1));
        });
        signupButton.setOnAction(e->{
            primaryStage.setScene(new SignupScene().display(primaryStage,scene1));
        });
...
/*
TODO Learn exception handling, ask for an example .excel file.
